...
1. Перенести файлы в корень проекта
2. Применить миграции
```
php artisan migrate
```
3. Применить Seed: он создаст первичное тестовое заполнение
```
php artisan db:seed
```
4. Api можно тестировать через postman, используйте для импорта файл postman.json в корне сайта
5. **Комментарии к реализации указала непосредственно в коде**
